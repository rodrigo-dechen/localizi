...
//    }
     ...
     * <code>boolean</code> ou <code>null</code> são preservados.
     ...
     * correspondente valor contido no array de dados, isto é, localiza-se um <br/>
     * índice no array de dados com a teg, e ela é substituída por esse valor.<br/>
     * O array <b>dados</b> é passado por referencia, e para cada ShortTeg <br/>
     * encontada o indice e removido do array, isto é, este metodo retira do seu <br/>
     * array os indices que coresponderão com alguma ShortTeg, A não ser que o<br/>
     ...
     * @param boolean $naoDeletar caso ele seta <b>TRUE</b> nao são deletados os <br/>
     * indices.
     * 
     ...
     * de sucesso, 0 se a consulta anterior não gerar um valor AUTO_INCREMENT,<br/> 
     * ou FALSE se não houver conexão MySQL foi criado.
     * @return int
     */
     ...
     * )</pre>
     * 
     * <b>OBS</b>.: Quando pasado desta maneira varios updates serão feitos.
     * 
     * O WHELE é constrido com ShotTegs e é subistituido pelo valor corespondente<br/>
     ...
     * )</pre>
     * 
     * <b>OBS</b>.: Quando pasado desta maneira varios deletes serão feitos.
     * 
     * O WHELE é constrido com ShotTegs e é subistituido pelo valor corespondente<br/>
     * no array de dados.<br/>
     * Exp.:<br/>
